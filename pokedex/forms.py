...
class PokemonForm(forms.ModelForm):
    class Meta:
        model = Pokemon
        fields = ['name', 'type', 'weight', 'height', 'picture', 'entrenador']  # ← aquí lo agregas
        widgets = {
            ...
            'entrenador': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ash Ketchum'}),  # ← aquí el widget
        }
